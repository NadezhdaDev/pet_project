...
// in pet_project/test/prefs_test.dart.
...
import 'package:pet_project/data/prefs/pp_prefs.dart' as _i4;
...
/// A class which mocks [PPPrefs].
///
/// See the documentation for Mockito's code generation for more information.
class MockPPPrefs extends _i1.Mock implements _i4.PPPrefs {
  MockPPPrefs() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> setLocale(_i5.Locale? locale) => (super.noSuchMethod(
        Invocation.method(
          #setLocale,
          [locale],
        ),
